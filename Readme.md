...
```
    ...
    Requirement already satisfied: fonttools>=4.22.0 in /Library/Frameworks/Python.framework/Versions/3.10/lib/python3.10/site-packages (from matplotlib>=3.1->seaborn) (4.37.3)
...
```
    ...
    <seaborn.axisgrid.FacetGrid at 0x1335b7eb0>
...
import matplotlib.pyplot as plt
sns.set_theme(style='ticks')
sns.relplot (data=covid, x="Lon", y="Lat", hue="Deaths", size="Confirmed", sizes=(40, 400)).set(ylim=(25,50),xlim=(-150,-50))
```




    <seaborn.axisgrid.FacetGrid at 0x131e07010>
...
```python
hospitals[hospitals['state_county']=="AK_Kenai Peninsula Borough"]['hospital_bed_count']
```
    ...
    42     6.0
    47    22.0
    Name: hospital_bed_count, dtype: float16
...
```
    ...
    Data columns (total 17 columns):
     #   Column           Non-Null Count  Dtype  
    ---  ------           --------------  -----  
     0   _id              3342 non-null   object 
     1   uid              3342 non-null   int64  
     2   country_iso2     3342 non-null   object 
     3   country_iso3     3342 non-null   object 
     4   country_code     3342 non-null   int64  
     5   fips             3332 non-null   float64
     6   county           3336 non-null   object 
     7   state            3342 non-null   object 
     8   country          3342 non-null   object 
     9   combined_name    3342 non-null   object 
     10  population       3234 non-null   float64
     11  loc              3234 non-null   object 
     12  date             3342 non-null   object 
     13  confirmed        3342 non-null   int64  
     14  deaths           3342 non-null   int64  
     15  confirmed_daily  3342 non-null   int64  
     16  deaths_daily     3342 non-null   int64  
...
```python
sns.relplot(data=Hospital_Covid_PerCounty, x="people_per_bed", y="mortality", hue="confirmed", size="population", sizes=(40, 100)).set(ylim=(0,0.065),xlim=(-500,6500))
```




    <seaborn.axisgrid.FacetGrid at 0x137465b10>
